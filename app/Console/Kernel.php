...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('app:digital-animals-owners-points-command')->weeklyOn(1, '04:00');

        //Digital Animals lords 20 token
        $schedule->command('app:digital-animals-lord20-command')->weeklyOn(1, '04:30');

        //Digital Animals roles
        $schedule->command('app:digital-animals-roles-command')->weeklyOn(1, '05:00');

        //Digital Animals long owner
        $schedule->command('app:digital-animals-long-range-owner-points-command')->weeklyOn(1, '05:30');
    }
