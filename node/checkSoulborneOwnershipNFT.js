...
const nfts = [
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '2' },
    { contractAddress: '0x09e8dc2fee2e6be7687ae44b1381dfd2e0c13465', tokenId: '2' }
];
...
async function main() {
    ...
    for (const nft of nfts) {
        ...
        if (ownerTokenBalance > 0) {
            ...
            ownershipResults.push(`User owns Soulborne Pass ${ownerTokenBalance} NFT ${nft.tokenId}/${nft.contractAddress}`);
        } else {
