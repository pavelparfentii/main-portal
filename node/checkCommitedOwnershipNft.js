...
const nfts = [
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '1' },
    { contractAddress: '0x09e8dc2fee2e6be7687ae44b1381dfd2e0c13465', tokenId: '1' }
];
...
async function main() {
    ...
    for (const nft of nfts) {
        ...
        if (ownerTokenBalance > 0) {
            ...
            ownershipResults.push(`User owns Committed Pass ${ownerTokenBalance} NFT ${nft.tokenId}/${nft.contractAddress}`);
        } else {
