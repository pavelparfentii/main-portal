...
const nfts = [
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '4' },
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '5' },
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '6' },
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '7' },
    { contractAddress: '0x3491ead95de2f4a945c2ead3c3afe7747f2ae373', tokenId: '8' },
];
...
async function main() {
    ...
    for (const nft of nfts) {
        ...
        if (ownerTokenBalance > 0) {
            ...
            ownershipResults.push(`User owns Lord of the Reapers Pass ${ownerTokenBalance} NFT ${nft.tokenId}/${nft.contractAddress}`);
        } else {
